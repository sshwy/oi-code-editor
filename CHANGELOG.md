...
- _(CodeEditor2)_ Ensure language is set correctly on tab state restoration

## [0.11.0] - 2026-03-14

### 🚀 Features

- _(code-editor)_ Expose tab item slot for header tabs

## [0.10.0] - 2026-03-14

### 🚀 Features

- _(tabs-panel)_ Allow custom tab item rendering
